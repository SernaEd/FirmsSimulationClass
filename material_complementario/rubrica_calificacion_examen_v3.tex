% ============================================================
%  RÚBRICA DE CALIFICACIÓN — PRIMER EXAMEN PARCIAL — VERSIÓN C
%  Cálculo III: Ecuaciones Diferenciales en Ingeniería (MT024)
%  Universidad Iberoamericana
%
%  NOTA PARA EL PROFESOR (comentario LaTeX, no se imprime):
%  Documento hermano de examen_primer_parcial_v3.tex y de su
%  solucionario (examen_primer_parcial_v3_solucionario.tex). El
...
% ---------- Encabezado ----------
\begin{center}
{\Large\bfseries RÚBRICA DE CALIFICACIÓN — PRIMER EXAMEN PARCIAL --- Versión C}\\[2pt]
{\small Cálculo III: Ecuaciones Diferenciales en Ingeniería (MT024) · Universidad Iberoamericana}\\[1pt]
{\small Documento hermano de \textit{examen\_primer\_parcial\_v3.tex} y su solucionario · Uso exclusivo del profesor}
\end{center}
...
b) & Tipo y orden correctos (\emph{orden} = 2; no confundir con el grado del término, que es 5) & 1 & \\
...
d) & Linealidad justificada (identifica el producto $p\,p'$ o el coeficiente dependiente de $p$) & 1.5 & \\
\end{tablarubrica}
...
d) & Encuentra $t=20$ con su restricción de dominio ($0\le t\le20$) & 1 & \\
e) & \textbf{Restringe el dominio de la fórmula y explica qué pasa físicamente para $t>20$} — punto central del problema & 5 & \\
\end{tablarubrica}

\textit{Nota crítica en (e): no dar crédito completo si el alumno solo reporta $h(t)=(6-0.3t)^2$ sin restringir el dominio ni explicar la continuación física, incluso si el resto del problema está correcto.}
...
\textit{Notas: en (a), 0 pts si el alumno solo señala un error aritmético sin mencionar la solución constante perdida. En (b), máximo 6/10 si el alumno da $y=-5$ sin justificar la unicidad con el teorema.}
