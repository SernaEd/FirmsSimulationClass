...
% ---------- Encabezado ----------
\begin{center}
{\Large\bfseries RÚBRICA DE CALIFICACIÓN — PRIMER EXAMEN PARCIAL --- Versión A}\\[2pt]
...
b) & Orden correcto (\emph{orden} = 2; no confundir con el grado del término, que es 3) & 1 & \\
