...
**Qué cubre esta tarea:** integra la teoría de la Sesión 9 (existencia y unicidad, independencia lineal, PVI vs. PVF, $y=y_c+y_p$) con los cuatro métodos de solución de la Sesión 10 (ecuación característica, Cauchy-Euler, el anulador, y su aplicación a un sistema físico forzado). Resuelvan mostrando **todo el procedimiento** — la respuesta final sin los pasos intermedios no demuestra que dominan el método, y el procedimiento es justo lo que van a poder revisar con una IA usando el prompt que acompaña esta tarea.

**Tiempo estimado:** 90–120 minutos. **Formato:** entregable individual, en su cuaderno o documento — muestren cada paso (ecuación característica o auxiliar, raíces, forma de la solución, aplicación de condiciones iniciales/frontera).
